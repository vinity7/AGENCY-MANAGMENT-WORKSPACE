...
const OrganizationLeadDashboard = ({ data, loading }) => {
  ...
  const projectHealth = data?.charts?.projectHealth || [];
  const revenueTrend = data?.charts?.revenueTrend || [];
  const utilization = data?.charts?.utilization || [];
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      {/* Quick Actions */}
      <QuickActions actions={quickActions} color="purple" />
        ...
        <div className="lg:col-span-4 bg-[#111111] border border-white/5 rounded-3xl p-6 h-[400px] flex flex-col">
          ...
          <div className="flex-1 w-full relative min-h-[300px]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-3xl font-black text-white">{data?.counts?.projects || 0}</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
         <WorkloadHeatmap data={utilization} />
