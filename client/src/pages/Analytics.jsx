    ...
    return (
        <div className="p-4 md:p-10 space-y-10 max-w-7xl mx-auto">
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                <div>
                    <h1 className="text-4xl font-black text-white tracking-tighter uppercase">Agency Analytics</h1>
                ...
                <div className="flex space-x-3">
                    <button onClick={exportCSV} className="flex items-center space-x-2 px-5 py-2.5 text-xs font-bold text-slate-400 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all shadow-sm">
                        <Download size={16} />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="glass-card p-8 rounded-2xl border-white/5">
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            <h3 className="text-xl font-black text-white tracking-tight uppercase">Intern Productivity</h3>
                            <p className="text-xs text-slate-500 font-bold mt-1 tracking-widest uppercase">TASKS COMPLETED VS. PENDING</p>
                        </div>
                    </div>
                    <div className="h-80 w-full">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={productivityData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                ...
                                <Tooltip cursor={{ fill: 'rgba(255,255,255,0.02)' }} contentStyle={{ backgroundColor: '#141414', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.5)' }} />
                                <Bar dataKey="completed" fill="#3b82f6" radius={[4, 4, 0, 0]} barSize={20} name="Completed" />
                                <Bar dataKey="pending" fill="rgba(255,255,255,0.05)" radius={[4, 4, 0, 0]} barSize={20} name="Pending" />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                </div>
                ...
                <div className="glass-card p-8 rounded-2xl border-white/5">
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            <h3 className="text-xl font-black text-white tracking-tight uppercase">Project Pipeline</h3>
                            <p className="text-xs text-slate-500 font-bold mt-1 tracking-widest uppercase">LIFECYCLE DISTRIBUTION</p>
                        </div>
                    </div>
                    <div className="h-80 w-full flex items-center justify-center relative">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                            <span className="text-4xl font-black text-white tracking-tighter">{projectMetrics.total}</span>
            ...
            <div className="glass-card p-8 rounded-2xl border-white/5 italic text-slate-500 text-sm text-center">
